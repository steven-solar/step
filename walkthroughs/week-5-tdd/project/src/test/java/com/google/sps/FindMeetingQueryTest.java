...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void optionalAttendeeAdjust() {
    // Add an optional attendee, adjust so he can attend.
    //
    // Events  :       |--A--|     |--B--|
    //                       |--C--|
    // Day     : |-----------------------------|
  ...
  public void allOptionalAttendees() {
    // Have all optional attendees, with a few open time slots.
    //
    // Events  : |--A--|          |--A--|
    //                      |--B--|           |--B--|
    // Day     : |----------------------------------|
  ...
  @Test
  public void optimizeOneOption() {
    // Add two optional attendees, with one optimal time slot.
    //
    // Events  :       |--A--|     |--B--|
    //           |--C--|     |--C--|     |--C--|
    //                       |--D--|     |--D--|
  ...
  @Test
  public void optimizeTwoOptions() {
    // Add two optional attendee, with two optimal time slots.
    //
    // Events  :       |--A--|     |--B--|
    //           |--C--|     |--C--|     
    //                       |--D--|     |--D--|
    ...
    @Test
  public void optimizeThreeOptions() {
    // Add two optional attendees, with one optimal time slot.
    //
    // Events  :       |--A--|     |--B--|
    //           |--C--|     |--D--|     |--C--|
